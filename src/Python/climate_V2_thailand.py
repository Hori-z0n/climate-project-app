...
def calculate_weighted_polygon(province_name, shapefile, data, cru):
    ...
    for idx, grid in grid_in_province.iterrows():
        ...
        if(cru == 'cld'):
            point_value = grid['Cloud-Cover']
        elif(cru == 'dtr'):
            point_value = grid['Diural-Temperature-Range']
        elif(cru == 'frs'):
            point_value = grid['Ground-Frost-Frequency']
        elif(cru == 'pet'):
            point_value = grid['Potential-Evapotranspiration']
        elif(cru == 'pre'):
            point_value = grid['Precipitation']
        elif(cru == 'tmn'):
            point_value = grid['Minimum-Temperature']
        elif(cru == 'tmp'):
            point_value = grid['Mean-Temperature']
        elif(cru == 'tmx'):
            point_value = grid['Maximum-Temperature']
        elif(cru == 'vap'):
            point_value = grid['Vapour-Pressure']
        elif(cru == 'wet'):
        ...
        weighted_temp = point_value * intersection_percentage_of_province
