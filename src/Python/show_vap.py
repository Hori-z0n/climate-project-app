...
data_var = ds.metpy.parse_cf('vap')
...
vap = data_filtered.sel(lon=slice(96, 106), lat=slice(4, 21), time=str(year))
data_avg = vap['vap'].mean(dim='time')
...
cbar.set_label('Vapour Pressure')
plt.show()
